	...
	return (
		<div
			className={`flex flex-col rounded-2xl border border-slate-200 bg-white p-8 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl ${
				plan.featured ? 'ring-2 ring-emerald-200' : ''
			}`}
		>
			...
			<button
				onClick={onSelect}
				className="mt-auto rounded-lg bg-emerald-600 px-4 py-3 text-sm font-semibold text-white shadow-xl transition-all duration-300 hover:-translate-y-0.5 hover:scale-[1.01] hover:bg-emerald-700"
			>
				Start plan
			</button>
		</div>
