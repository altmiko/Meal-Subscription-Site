		...
		<footer className="border-t border-slate-200 bg-white">
			<div className="mx-auto flex max-w-7xl flex-col gap-8 px-4 py-12 lg:flex-row lg:items-center lg:justify-between lg:px-8">
				...
				<div className="flex flex-wrap gap-3">
					<Link
						to="/register"
						className="rounded-lg bg-emerald-600 px-6 py-3 text-sm font-semibold text-white shadow-xl transition-all duration-300 hover:-translate-y-0.5 hover:scale-[1.01] hover:bg-emerald-700"
					>
						Start subscription
					</Link>
					<Link
						to="/restaurants"
						className="rounded-lg border border-slate-200 px-6 py-3 text-sm font-semibold text-slate-900 transition-all duration-300 hover:-translate-y-0.5 hover:border-emerald-200 hover:bg-emerald-50"
					>
						Browse kitchens
					</Link>
				</div>
